...
class GHCDatasetReaderConfig(DatasetReaderConfig):
    _target_: str = "hateSpeech.data_processing.dataset_readers.GHCDatasetReader"
    dev_split_ratio: float = MISSING

@dataclass
class JigsawToxicCommentsDatasetReaderConfig(DatasetReaderConfig):
    _target_: str = "hateSpeech.data_processing.dataset_readers.JigsawToxicCommentsDatasetReader"
    dev_split_ratio: float = MISSING

@dataclass
class TwitterDatasetReaderConfig(DatasetReaderConfig):
    _target_: str = "hateSpeech.data_processing.dataset_readers.TwitterDatasetReader"
    dev_split_ratio: float = MISSING
    test_split_ratio: float = MISSING

@dataclass
class DatasetReaderManagerConfig:
    _target_: str = "hateSpeech.data_processing.dataset_readers.DatasetReaderManager"
