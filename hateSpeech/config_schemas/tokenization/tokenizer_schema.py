...
import hateSpeech.config_schemas.tokenization.decoder_schema as decoder_schemas
import hateSpeech.config_schemas.tokenization.model_schema as model_schemas
import hateSpeech.config_schemas.tokenization.normalizer_schema as normalizer_schemas
import hateSpeech.config_schemas.tokenization.post_processor_schema as post_processor_schemas
import hateSpeech.config_schemas.tokenization.pre_tokenizer_schema as pre_tokenizer_schemas
import hateSpeech.config_schemas.tokenization.trainer_schema as trainer_schemas
...
class HuggigFaceTokenizerConfig(TokenizerConfig):
    _target_: str = "hateSpeech.tokenization.tokenizers.HuggingFaceTokenizer"
