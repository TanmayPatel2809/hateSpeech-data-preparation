...
from hateSpeech.utils.config_utils import compose_config, config_args_parser, save_config_as_pickle, save_config_as_yaml
...
def generate_final_config(args: argparse.Namespace) -> None:
    ...
    config_save_dir = Path("./hateSpeech/configs/automatically_generated")
